...
import {
  DashboardOutlined, ApartmentOutlined, BellOutlined,
  AppstoreOutlined, HomeOutlined, TeamOutlined,
  BarChartOutlined, SettingOutlined, FireOutlined, ExperimentOutlined,
